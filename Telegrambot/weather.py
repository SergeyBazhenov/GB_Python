...
APPID = "bcf0f458a0dee1724256aeb4cb7df12e"  # <-- Put your OpenWeatherMap appid here!
...
def weather_onecall(lat: float = '', lon: float = '', cnt: int = 1, units: str = 'metric', lang: str = 'ru', appid: str = APPID) -> dict:
    ...
    #weather = ()
    #print('Сегодня {}, температура: {}°' .format(weather_des, temp))
...
# lat, lon = current_weather(location)
# print(weather_onecall(lat, lon))
